...
import com.cindodcindy.vieroshoesnew.view.Chat_page;
import com.cindodcindy.vieroshoesnew.view.Order_page;
...
public class AdapterHome extends RecyclerView.Adapter<AdapterHome.HomeChild> {
    ...
    public class HomeChild extends RecyclerView.ViewHolder {
        private final TextView textView_nama_aitem;

        private final ImageView imageView_maps;
        private final ImageView imageView_order;
        private final ImageView imageView_chat;
